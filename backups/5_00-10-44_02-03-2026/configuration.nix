...

{
  ...
  services.power-profiles-daemon.enable = false; # Crucial: prevent conflicts
  
  services.system76-scheduler = {
    enable = true;
    settings.cfsProfiles.enable = false; # Let TLP handle AC/Battery profiles
    settings.processScheduler.enable = true; # Keep this on for app priority
  };
  ...
  # Enable/Disable the Budgie Desktop environment.
  services.xserver.displayManager.lightdm.enable = false;
  services.xserver.desktopManager.budgie.enable = false;
  
  # Enable/Disable the Cosmic Desktop environment
