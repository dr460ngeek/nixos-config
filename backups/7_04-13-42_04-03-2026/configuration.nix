...

{
  ...
  services.displayManager.cosmic-greeter.enable = false; # Cosmic greeter dm
  services.xserver.displayManager.lightdm.enable = true; # LightDM 
  
  # Enable/Disable the Desktop environment
  services.desktopManager.cosmic.enable = false ; # Cosmic DE (Wayland)
  services.xserver.desktopManager.cinnamon.enable = true; # CinnamonDE (X11)
  ...
  #  wget
	...
	gobject-introspection # For CDW
	imagemagick # For CDW
	gtk3 # For CDW & other GTK3 related things.
  ];
